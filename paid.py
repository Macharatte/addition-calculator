...
# --- 言語リソース（すべてのKeyErrorを回避するために全言語分定義） ---
LANG = {
    ...
    "ZH": {"title": "Python 计算器", "modes": ["普通", "科学", "统计", "单位", "付费功能"], "tax_menu": "税务", "curr_menu": "汇率", "res": "结果", "exec": "计算", "amount": "金额"},
...
with col_lang:
    selected_lang = st.selectbox("", ["JP", "EN", "ZH", "HI", "ES", "AR", "FR", "RU", "PT"], index=["JP", "EN", "ZH", "HI", "ES", "AR", "FR", "RU", "PT"].index(st.session_state.lang), label_visibility="collapsed")
